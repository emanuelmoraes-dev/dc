...
#define UC_ERR_CHECK_OVERFLOW_ADD(a, x, MIN_VALUE, MAX_VALUE, largeArgName, smallArgName) (\
    UC_ERR_IS_OVERFLOW_LARGE_ADD(a, x, MIN_VALUE, MAX_VALUE) ? UC_ERR_THROW_OVERFLOW(UC_ERR_ARG_OVERFLOW_##largeArgName) :\
    UC_ERR_IS_OVERFLOW_SMALL_ADD(a, x, MIN_VALUE, MAX_VALUE) ? UC_ERR_THROW_OVERFLOW(UC_ERR_ARG_OVERFLOW_##smallArgName) :\
    C_OK\
)
...
#define UC_ERR_CHECK_OVERFLOW_SUB(a, x, MIN_VALUE, MAX_VALUE, largeArgName, smallArgName) (\
    UC_ERR_IS_OVERFLOW_LARGE_SUB(a, x, MIN_VALUE, MAX_VALUE) ? UC_ERR_THROW_OVERFLOW(UC_ERR_ARG_OVERFLOW_##largeArgName) :\
    UC_ERR_IS_OVERFLOW_SMALL_SUB(a, x, MIN_VALUE, MAX_VALUE) ? UC_ERR_THROW_OVERFLOW(UC_ERR_ARG_OVERFLOW_##smallArgName) :\
    C_OK\
)
...
#define UC_ERR_CHECK_OVERFLOW_MULT(a, x, MIN_VALUE, MAX_VALUE, largeArgName, smallArgName) (\
    UC_ERR_IS_OVERFLOW_LARGE_MULT(a, x, MIN_VALUE, MAX_VALUE) ? UC_ERR_THROW_OVERFLOW(UC_ERR_ARG_OVERFLOW_##largeArgName) :\
    UC_ERR_IS_OVERFLOW_SMALL_MULT(a, x, MIN_VALUE, MAX_VALUE) ? UC_ERR_THROW_OVERFLOW(UC_ERR_ARG_OVERFLOW_##smallArgName) :\
    C_OK\
)
